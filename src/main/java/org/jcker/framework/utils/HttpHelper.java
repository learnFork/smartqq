...
//        System.out.println("result = " + result.toString());
    ...
    /*	String url=URLEncoder.encode("http://www.daolangliu.cn/wenxin/auth/authToken.do");
        ...
        String token = sendGet("https://api.weixin.web.com/cgi-bin/token?grant_type=client_credential&appid=wxb6046cd738463fbe&secret=45e5e0305ddee92705fd6399b2377fad");
        System.out.println(token);
    }
}
